    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[var(--bg)] py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="font-mono text-xs text-[var(--ink-dim)] mb-2">// what i build</div>
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--heading)]">Two kinds of projects</h2>
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-5">
            ...
            >
              <div className="flex items-center gap-2 font-mono text-xs text-[var(--ink-dim)] mb-3">
                <span className="px-1.5 py-0.5 bg-[var(--bg-card)] rounded">websites.tsx</span>
              </div>
              <h3 className="text-xl font-semibold text-[var(--heading)]">Websites &amp; online stores</h3>
              <p className="mt-2 text-[var(--ink)]">Your customers can find you, trust you, and buy from you.</p>
              <ul className="mt-4 space-y-1.5 text-sm text-[var(--ink-soft)] font-mono">
                <li>· Marketing sites &amp; portfolios</li>
                <li>· Online stores &amp; custom carts</li>
                <li>· Fast, mobile-first, SEO-ready</li>
              </ul>
              <div className="mt-5 text-[var(--accent)] font-mono text-sm group-hover:text-[var(--accent-bright)]">open →</div>
            </Link>
            ...
            >
              <div className="flex items-center gap-2 font-mono text-xs text-[var(--ink-dim)] mb-3">
                <span className="px-1.5 py-0.5 bg-[var(--bg-card)] rounded">automation.py</span>
              </div>
              <h3 className="text-xl font-semibold text-[var(--heading)]">Internal tools &amp; automation</h3>
              <p className="mt-2 text-[var(--ink)]">Your team stops wasting hours on manual work.</p>
              <ul className="mt-4 space-y-1.5 text-sm text-[var(--ink-soft)] font-mono">
      ...
      {/* Selected work */}
      <ScrollReveal>
      <section className="bg-[var(--bg-soft)] py-20 border-t border-[var(--line)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8 flex-wrap gap-3">
            <div>
              <div className="font-mono text-xs text-[var(--ink-dim)] mb-2">// selected work</div>
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--heading)]">Shipped and in production</h2>
              <p className="mt-3 text-[var(--ink-soft)] max-w-2xl">Built for real people running real businesses — each one live today.</p>
            </div>
            <Link href="/work" className="font-mono text-sm text-[var(--accent)] hover:text-[var(--accent-bright)]">see all →</Link>
          </div>

          <div className="grid md:grid-cols-2 gap-5">
            <Link
              href="/work"
              className="group rounded-xl border border-[var(--line)] overflow-hidden bg-[var(--bg)] hover:border-[var(--accent)] transition-colors"
            >
              <div className="relative aspect-[16/10] bg-[var(--bg-soft)]">
                <Image
              ...
              <div className="p-5">
                <div className="font-mono text-xs text-[var(--accent)]">content-creator</div>
                <h3 className="text-lg font-semibold text-[var(--heading)] mt-1">Iowan Foodie</h3>
                <p className="text-sm text-[var(--ink-soft)] mt-1">Food content portfolio and blog.</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="p-5">
                <div className="font-mono text-xs text-[var(--accent)]">e-commerce</div>
                <h3 className="text-lg font-semibold text-[var(--heading)] mt-1">Two Makers Co</h3>
                <p className="text-sm text-[var(--ink-soft)] mt-1">Custom online store for 3D-printed home decor.</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="bg-[var(--bg)] py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="font-mono text-xs text-[var(--ink-dim)] mb-2">// whoami</div>
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--heading)]">Hi, I&apos;m Josh</h2>
      ...
      <section className="bg-[var(--bg-soft)] py-20 border-t border-[var(--line)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="font-mono text-xs text-[var(--ink-dim)] mb-2">// how it works</div>
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--heading)]">What hiring me looks like</h2>

          <div className="mt-8 rounded-xl border border-[var(--line)] bg-[var(--bg)] overflow-hidden">
            <div className="bg-[var(--bg-soft)] border-b border-[var(--line)] px-4 py-2 flex items-center gap-2">
              ...
              <span className="font-mono text-xs text-[var(--ink-dim)] ml-2">~/fritz-automation/process.sh</span>
            </div>
            <div className="p-5 font-mono text-sm leading-relaxed">
              <div><span className="text-[var(--accent)]">$</span> <span className="text-[var(--ink)]">fritz chat</span></div>
              <div className="text-[var(--ink-dim)] ml-3">→ Free 30-minute call. We figure out if I&apos;m the right fit for your project.</div>

              <div className="mt-3"><span className="text-[var(--accent)]">$</span> <span className="text-[var(--ink)]">fritz propose</span></div>
              <div className="text-[var(--ink-dim)] ml-3">→ Within a few days, a written proposal: scope, timeline, and a fixed price.</div>

              <div className="mt-3"><span className="text-[var(--accent)]">$</span> <span className="text-[var(--ink)]">fritz build</span></div>
              <div className="text-[var(--ink-dim)] ml-3">→ I build. You see progress weekly and can request changes along the way.</div>

              <div className="mt-3"><span className="text-[var(--accent)]">$</span> <span className="text-[var(--ink)]">fritz launch</span></div>
              <div className="text-[var(--ink-dim)] ml-3">→ Ship it. First month of support is on me; retainer after that if you want it.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[var(--bg)] py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--heading)]">Have a project in mind?</h2>
