...
export default async function HomePage() {
  ...
  const stats = [
    ...
    { value: '100K+', label: 'Daily Records Processed' },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="block text-slate-600 text-2xl md:text-3xl font-normal mb-2">Stop Wasting Hours on</span>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-8 pt-8 border-t border-slate-200">
              {['20+ Years Experience', 'Enterprise Scale', '100K+ Daily Records'].map((item) => (
