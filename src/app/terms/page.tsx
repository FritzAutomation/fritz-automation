      ...
      <section className="py-16 bg-slate-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">2. Services</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">3. Client Responsibilities</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">4. Intellectual Property</h2>

            <h3 className="text-xl font-semibold text-slate-100 mt-8 mb-3">Our Intellectual Property</h3>
            <p className="text-slate-600 mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-100 mt-8 mb-3">Client Deliverables</h3>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">5. Confidentiality</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">6. Payment Terms</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">7. Warranties and Disclaimers</h2>

            <h3 className="text-xl font-semibold text-slate-100 mt-8 mb-3">Service Warranty</h3>
            <p className="text-slate-600 mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-100 mt-8 mb-3">Website Disclaimer</h3>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">8. Limitation of Liability</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">9. Indemnification</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">10. Termination</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">11. Governing Law</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">12. Changes to Terms</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">13. Severability</h2>
            <p className="text-slate-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mt-12 mb-4">14. Contact Information</h2>
            <p className="text-slate-600 mb-4">
