          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm">
                <h2 className="text-xl font-bold mb-6 text-slate-900">Contact Information</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:forward@fritzautomation.dev" className="text-slate-600 hover:text-primary transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/FritzAutomation" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-primary transition-colors">
                        @FritzAutomation
                      </a>
                    </div>
                  </div>
