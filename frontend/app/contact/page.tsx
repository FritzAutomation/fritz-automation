                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:forward@fritzautomation.dev" className="text-gray-600 hover:text-primary transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-gray-900">GitHub</h3>
                      <a href="https://github.com/FritzAutomation" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">
                        @FritzAutomation
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1 text-gray-900">LinkedIn</h3>
                      <a href="https://www.linkedin.com/in/joshua-fritzjunker-53383590/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary transition-colors">
                        Joshua Fritzjunker
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full px-8 py-4 bg-gradient-to-r from-primary to-primary-light text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {status === 'loading' ? (
                      <>
